...
function loadPerson()
{
	...
	$('[contenteditable=true].person-field').off('keyup');
	$('[contenteditable=true].person-field').on('keyup', function () {
		field = this;
		typewatch(function () {
			if(person[$(field).attr('id')] != $(field).html())
			{
				person[$(field).attr('id')] = $(field).html();
				if(selectedIDType == 'person')
					loadList('person');
			}
		}, 250);
...
function loadPlace()
{
	...
	$('[contenteditable=true].place-field').off('keyup');
	$('[contenteditable=true].place-field').on('keyup', function () {
		field = this;
		typewatch(function () {
			if(place[$(field).attr('id')] != $(field).html())
			{
				place[$(field).attr('id')] = $(field).html();
				if(selectedIDType == 'place')
					loadList('place');
			}
		}, 250);
...
function loadThing()
{
	...
	$('[contenteditable=true].thing-field').off('keyup');
	$('[contenteditable=true].thing-field').on('keyup', function () {
		field = this;
		typewatch(function () {
			if(thing[$(field).attr('id')] != $(field).html())
			{
				thing[$(field).attr('id')] = $(field).html();
				if(selectedIDType == 'thing')
					loadList('thing');
			}
		}, 250);
...
function loadNote()
{
	...
	$('[contenteditable=true].note-field').off('keyup');
	$('[contenteditable=true].note-field').on('keyup', function () {
		field = this;
		typewatch(function () {
			if(note[$(field).attr('id')] != $(field).html())
			{
				note[$(field).attr('id')] = $(field).html();
				if(selectedIDType == 'note')
					loadList('note');
			}
		}, 250);
